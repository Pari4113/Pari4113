...
🎓 **[AcademiVerse](https://github.com/hetvijoshi/AcademiVerse)** — Full-stack learning management platform with AI-powered quiz generation  
`Spring Boot` `Next.js` `PostgreSQL` `AWS` `OpenAI API` `CircleCI`

🔗 **[Scalable URL Shortener](https://github.com/Pari4113/ScalableURLShortener)** — Distributed backend service with sub-45ms redirect response times  
